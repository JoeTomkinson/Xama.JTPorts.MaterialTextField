...
If you want to support the work that I do and you find any of these libraries useful? Consider supporting it by joining [**stargazers**](https://github.com/DigitalSa1nt/Xama.JTPorts.MaterialTextField/stargazers) for this repository. :telescope: :stars:
